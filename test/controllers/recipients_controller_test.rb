...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { birthday: @recipient.birthday, name: @recipient.name, notes: @recipient.notes, relationship: @recipient.relationship }
    end
  ...
  test "should update recipient" do
    patch :update, id: @recipient, recipient: { birthday: @recipient.birthday, name: @recipient.name, notes: @recipient.notes, relationship: @recipient.relationship }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
